<template>
  <div>
    <div
      class="relative w-64 bg-white p-4 shadow-lg rotate-[-2deg] hover:rotate-0 transition-transform duration-300 cursor-pointer"
      @click="openModal"
      v-if="imageUrl!==null"
    >
      ...
      <Transition name="modal">
        ...
        >
          <div class="bg-white rounded-lg p-6 max-w-md w-full relative">
            ...
            <h2 class="text-xl font-bold mb-4">{{ caption }}</h2>
            <div class="mb-4">
              <img 
                v-if="imageUrl!==null"
                :src="imageUrl" 
